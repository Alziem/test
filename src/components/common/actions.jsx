...
export const Fetch = async (table) => {
  return http
    .getData(null, `${http.BASE_URL_ADMIN}/${table}`, true)
    .then((res) => {
      if (handlingData(res)) {
        return {
          data: res.data.data,
...
export const Create = (table, data) => {
  ...
  http
    .postData(data, `${http.BASE_URL_ADMIN}/${table}`, false)
...
export const Update = (table, data, id) => {
  ...
  http
    .postData(data, `${http.BASE_URL_ADMIN}/${table}/${id}?_method=PUT`, false)
...
export const UpdateStatus = async (table, id) => {
  ...
  return http
    .postData(null, `${http.BASE_URL_ADMIN}/${table}/status/${id}?_method=PUT`, false)
...
export const Delete = (table, index) => {
  ...
  http
    .deleteData(null, `${http.BASE_URL_ADMIN}/${table}/${index}`, true)
    .then((res) => {
      handlingData(res);
    })
    .catch((err) => {
...
export const View = async(table, index) => {
  ...
  return http
    .getData(null, `${http.BASE_URL_ADMIN}/${table}/${index}`, true)
    .then((res) => {
      if (handlingData(res)) {
        return {
          data: res.data.data,
